...
#
# from src.services import path_to_file
#
#
# logging.basicConfig(level=logging.INFO,
#                     filename=f'{path_to_file("log", "mylog.txt")}',
#                     filemode='a',
#                     format='%(levelname)s: %(asctime)s - %(funcName)s() - %(message)s')
#
#
# def get_log_decorator(filename: str = f'{path_to_file("log", "report.txt")}') -> Callable[[Callable], Callable]:
#     """
